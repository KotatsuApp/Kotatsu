...
class AppSettings @Inject constructor(@ApplicationContext context: Context) {
	...
	val isDescriptionTranslationEnabled: Boolean
		get() = prefs.getBoolean(KEY_TRANSLATE_DESCRIPTION, false)
	...
	companion object {
		...
		const val KEY_TRANSLATE_DESCRIPTION = "translate_description"
